...
string Treugol(int i, int AllType)
{
    double a, b, c, max, k, chisl, znam, S, h1, h2, h;
            ...
            case 5:     // Угол между биссектрисой и медианой
                ...
                cout << "%" << (i + 1) << endl;
                cout << "\\item\n" << endl << "\\begin{geometrytask}" << endl;
                cout << "        Острый угол $B$ прямоугольного треугольника $ABC$ равен $" << betta << "^{\\circ}$. Найдите величину угла между биссектрисой $CD$ и медианой $CM$, проведёнными из вершины прямого угла $C$. Ответ дайте в градусах." << endl;
                cout << "\\end{geometrytask}\\hfill" << endl << "\\begin{tikzpicture}[scale=0.7, baseline=(current bounding box.center)] % Добавлено baseline" << endl
...
string ZadMove()
{
            ...
            case 12:
                ...
                cout << "\\item     Расстояние между пристанями А и В равно $" << a[0] << "$ км. Из А в В по течению реки отправился пло, а через $" << a[3] << "$ часа вслед за ним отправилась яхта, которая, прибыв в пункт В, тотчас повернула обратно и возвратилась в А. К этому времени плот проплыл $" << a[2] << "$ км. Найдите скорость яхты в неподвижной воде, если скорость течения реки равна $" << a[1] << "\\frac{\\text{км}}{\\text{ч}}$. Ответ дайте в $\\frac{\\text{км}}{\\text{ч}}$." << endl;
                //cout << "\\\\" << answer << endl;
                Answer = "  \\item " + to_string(answer) + " \n";
                break;
...
string Finance2(int Type)
{
    ...
    if(Type == 1)
    {
        cout << "\\item     В июле 2016 года планируется взять кредит в банке на три года в размере S млн рублей, где S - целое число. Условия его возврата таковы:" << endl
            << "\\begin{itemize}" << endl
            ...
            << "\\begin{table}[h!]" << endl
            << "    \\centering" << endl
            << "    \\begin{tabular}{| m{3.5cm} | m{2cm} | m{2cm} | m{2cm} | m{2cm} |}" << endl
            << "    \\hline" << endl
            ...
            << "\\end{tabular}" << endl
            << "\\end{table}" << endl
            << "Найдите наибольшее значение S, при котором каждая из выплат будет меньше 5 млн рублей." << endl << endl << endl; 
        Answer = "  \\item 7 \n";
        ...
        cout << "\\item     В июле 2016 года планируется взять кредит в банке на три года в размере S млн рублей, где S - целое число. Условия его возврата таковы:" << endl
            ...
            << "\\end{tabular}" << endl
            << "\\end{table}" << endl
            << "Найдите наибольшее значение S, при котором каждая из выплат будет меньше 4 млн рублей." << endl << endl << endl; 
    ...
    do {
        ...
        case 1:
            do {
                ...
                cout << "11. Задание 8: Производная  (" << count_task[24] << ")" << endl;
                cout << "12. Задание 12: Максимальное и минимальное значение (" << count_task[25] + count_task[26] + count_task[27] + count_task[28] << ")" << endl;
                cout << "13. Задание 13: Уравнения (" << count_task[29] + count_task[30] + count_task[31] + count_task[32] + count_task[33]  + count_task[34]  + count_task[35]  << ")" << endl;
                cout << "14. Задание 15. Неравенства (" << count_task[36] + count_task[37] + count_task[38] + count_task[39] + count_task[40]  << ")" << endl;
                cout << "15. Задание 16. Экономические задачи (" << count_task[41] + count_task[42] + count_task[43] + count_task[44]  << ")" << endl;
                cout << "16. Задание 14. Стереометрические задачи (" << count_task[45] + count_task[46] + count_task[47] + count_task[48] << ")" << endl;
                cout << "17. Задание 17. Планиметрические задачи (" << count_task[49] + count_task[50] + count_task[51] + count_task[52] << ")" << endl;
                cout << "18. Задание 18. Параметры (" << count_task[53] + count_task[54] + count_task[55] << ")"  << endl;
                cout << "19. Задание 19. Теория чисел (" << count_task[56] + count_task[57]  << ")" << endl << endl;
                ...
                case 10:
                    do{
                        ...
                        cout << "4. Все целиком (" << count_task[23] << ")" << endl << endl;
                        cout << "0. Назад" << endl;
                        cout << "Ваш выбор: ";
                        cin >> choice;
                        switch(choice)
                ...
                case 12:
                    do{
                        ...
                        cout << "4. Все целиком (" << count_task[28] << ")" << endl << endl;
                        cout << "0. Назад" << endl;
                        cout << "Ваш выбор: ";
                        cin >> choice;
                        switch(choice)
                ...
                case 69:
                    ...
                    if (count_task[18] != 0)
                    {
                        ...
                        {
                            Answers = Answers + Graphics(Count);
                            Count++;
                        }
                        count_task[18] = 0;
                    }
                    ...
                    if (count_task[24] != 0)
                    {
                        ...
                        {
                            Answers = Answers + Proizvodn(Count);
                            Count++;
                        }
                        count_task[24] = 0;
                    }
                    ...
                    if (count_task[27] != 0)
                    {
                        ...
                        {
                            Answers = Answers + ProizvTrigonom();
                            Count++;
                        }
                        count_task[27] = 0;
                    }
